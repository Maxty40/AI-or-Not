...
export const QUIZ_ITEMS: ImageChallengeItem[] = [
  ...
  },
  {
    ...
    isAi: true,
    title: 'Foto Wajah Pria Muda Tanpa Ekspresi Menghadap Kamera',
    category: 'Potret Wajah',
    difficulty: 'Tantangan',
  ...
  },
  {
    ...
    isAi: false,
    title: 'Pemandangan Pantai dengan Tebing Batu',
    category: 'Hewan & Alam',
    difficulty: 'Sedang',
    source: 'Fotografi lanskap dokumenter',
    creatorInfo: 'Fotografi Asli: Landscape Photography',
    clues: ['Buih ombak memiliki bentuk tidak berulang.', 'Lapisan batu menunjukkan erosi alami.', 'Kabut atmosfer mengurangi kontras objek jauh.'],
  ...
  },
  {
    ...
    clues: ['Tekstur kulit terlalu seragam.', 'Tataoan mata terlalu kosong.', 'Tekstur bibir terlalu halus.'],
